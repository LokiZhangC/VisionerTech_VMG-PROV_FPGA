...
xst -ifn xst.scr
move sensor_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\sensor_clk.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc sensor_clk.ucf sensor_clk_exdes

echo 'Running map'
map -timing -pr b sensor_clk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm sensor_clk_exdes -w routed.ncd routed.v
cd ..
