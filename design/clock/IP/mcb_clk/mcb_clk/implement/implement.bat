...
xst -ifn xst.scr
move mcb_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\mcb_clk.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc mcb_clk.ucf mcb_clk_exdes

echo 'Running map'
map -timing -pr b mcb_clk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm mcb_clk_exdes -w routed.ncd routed.v
cd ..
